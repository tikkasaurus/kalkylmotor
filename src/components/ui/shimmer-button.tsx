  ...
  (
    ...
    return (
      <button
        ...
        className={cn(
          "group relative z-0 flex h-9 cursor-pointer items-center justify-center overflow-hidden border border-white/10 px-6 py-3 whitespace-nowrap text-white [background:var(--bg)]",
